...
public class Judge2 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.judge_2);
...
//        ROPE Mallakhamb
    ...
    public void onBackPressed() {
        ...
        buid.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Judge2.this,MainActivity.class));
            }
        });
                ...
                if (compName.getText().length()!=0 && teamName.getText().length()!=0&&
                    ...
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Judge2.this, "Check the Details", Toast.LENGTH_SHORT).show();
                        }
                    });
