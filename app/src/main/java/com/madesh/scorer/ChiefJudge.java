...
public class ChiefJudge extends AppCompatActivity implements AdapterView.OnItemSelectedListener {


    Button PPdf, RPdf, HPdf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chief_judge);
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);


        PPdf = findViewById(R.id.polePDF);
        RPdf = findViewById(R.id.ropePDF);
        HPdf = findViewById(R.id.hangingPDF);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder buid = new AlertDialog.Builder(ChiefJudge.this);
                buid.setMessage("Are you sure want to exit the panel?");
        ...
        playerNameh1 = findViewById(R.id.PlayerNameh1);playerNameh2 = findViewById(R.id.PlayerNameh2);playerNameh3 = findViewById(R.id.PlayerNameh3);
...
//        HANGING Mallakhamb
        ...
        executionh = findViewById(R.id.Executionh);executionh2 = findViewById(R.id.Executionh2);executionh3 = findViewById(R.id.Executionh3);executionh4 = findViewById(R.id.Executionh4);executionh5 = findViewById(R.id.Executionh5);executionh6 = findViewById(R.id.Executionh6);
...
//        ROPE Mallakhamb
        ...
        p1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (RoomCode.getText().length() == 0||compName.getText().length()==0||teamName.getText().length()==0||
                typeSpin.getSelectedItemPosition()==0||ageSpin.getSelectedItemPosition()==0) {
                    Toast.makeText(ChiefJudge.this, "Enter Room Code & Competition name & Age Group", Toast.LENGTH_SHORT).show();
                    RoomCode.setError("Room Code is required");
                    compName.setError("Competition name is required");
    ...
    {
        if (ContextCompat.checkSelfPermission(ChiefJudge.this, permission)
                == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(ChiefJudge.this,
    ...
    public void onBackPressed() {
        ...
        buid.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
               startActivity(new Intent(ChiefJudge.this,MainActivity.class));
            }
        });
        AlertDialog alertDialog = buid.create();
        alertDialog.show();
...
//HANGING MALLAKHAMB
            ...
            case R.id.confirmh6:
                if ( difficultyFinalh6.getText().length() == 0 ||
                    ...
                    HPdf.setVisibility(View.VISIBLE);
...
//                ROPE MALLAKHAMB
            ...
            case R.id.confirmr6:
                if ( difficultyFinalr6.getText().length() == 0 ||
                    ...
                    collectionReference.document("Chief Judge").set(user);
                    RPdf.setVisibility(View.VISIBLE);
                }
                break;
        }
    }
    ...
    public void generatePDF(View view) {
        ...
        if (playerName3.length() == 0) {
            playerName3.setText("-");
        }
        if (playerName4.length() == 0) {
            playerName4.setText("-");
        }
        if (playerName5.length() == 0) {
            playerName5.setText("-");
        }
        if (playerName6.length() == 0) {
            playerName6.setText("-");
        }
        if (playerNameh1.length() == 0) {
            playerNameh1.setText("-");
        }
        if (playerNameh2.length() == 0) {
            playerNameh2.setText("-");
        }
        if (playerNameh3.length() == 0) {
            playerNameh3.setText("-");
        }
        if (playerNameh4.length() == 0) {
            playerNameh4.setText("-");
        }
        if (playerNameh5.length() == 0) {
            playerNameh5.setText("-");
        }
        if (playerNameh6.length() == 0) {
            playerNameh6.setText("-");
        }
        if (playerNamer1.length() == 0) {
            playerNamer1.setText("-");
        }
        if (playerNamer2.length() == 0) {
            playerNamer2.setText("-");
        }
        if (playerNamer3.length() == 0) {
            playerNamer3.setText("-");
        }
        if (playerNamer4.length() == 0) {
            playerNamer4.setText("-");
        }
        if (playerNamer5.length() == 0) {
            playerNamer5.setText("-");
        }
        if (playerNamer6.length() == 0) {
            playerNamer6.setText("-");
        }

        if (compName.length() == 0) {
            compName.setError("Competition Name is Required");
            Toast.makeText(ChiefJudge.this, "Competition Name is Required", Toast.LENGTH_SHORT).show();
        }
        if (teamName.length() == 0) {
            teamName.setError("Enter Player's Team");
            Toast.makeText(ChiefJudge.this, "Enter Player's Team", Toast.LENGTH_SHORT).show();
        } else {
                ...
                String CompName = compName.getText().toString();
                String TeamName = teamName.getText().toString();
                String AgeGrp = ageSpin.getSelectedItem().toString();
                String Name1 = playerName.getText().toString();
                String Name2 = playerName2.getText().toString();
                String Name3 = playerName3.getText().toString();
                String Name4 = playerName4.getText().toString();
                String Name5 = playerName5.getText().toString();
                String Name6 = playerName6.getText().toString();
                String Nameh1 = playerNameh1.getText().toString();
                String Nameh2 = playerNameh2.getText().toString();
                String Nameh3 = playerNameh3.getText().toString();
                String Nameh4 = playerNameh4.getText().toString();
                String Nameh5 = playerNameh5.getText().toString();
                String Nameh6 = playerNameh6.getText().toString();
                String Namer1 = playerNamer1.getText().toString();
                String Namer2 = playerNamer2.getText().toString();
                String Namer3 = playerNamer3.getText().toString();
                String Namer4 = playerNamer4.getText().toString();
                String Namer5 = playerNamer5.getText().toString();
                String Namer6 = playerNamer6.getText().toString();
                String grandTotalh = FPTotalh.getText().toString();
                String grandTotalh2 = FPTotalh2.getText().toString();
                String grandTotalh3 = FPTotalh3.getText().toString();
                String grandTotalh4 = FPTotalh3.getText().toString();
                String grandTotalh5 = FPTotalh4.getText().toString();
                String grandTotalh6 = FPTotalh5.getText().toString();
                String grandTotal = FPTotal.getText().toString();
                String grandTotal2 = FPTotal2.getText().toString();
                String grandTotal3 = FPTotal3.getText().toString();
                String grandTotal4 = FPTotal3.getText().toString();
                String grandTotal5 = FPTotal4.getText().toString();
                String grandTotal6 = FPTotal5.getText().toString();
                String grandTotalr = FPTotalr.getText().toString();
                String grandTotalr2 = FPTotalr2.getText().toString();
                String grandTotalr3 = FPTotalr3.getText().toString();
                String grandTotalr4 = FPTotalr3.getText().toString();
                String grandTotalr5 = FPTotalr4.getText().toString();
                String grandTotalr6 = FPTotalr5.getText().toString();
                ...
                if (s11.equals(ref) || s12.equals(ref) || s13.equals(ref) || s14.equals(ref) || s21.equals(ref) || s22.equals(ref) ||
                    ...
                    Toast.makeText(ChiefJudge.this, "Make Sure to Refresh Judges Score", Toast.LENGTH_SHORT).show();
                }
                switch (view.getId()) {
                    ...
                    case R.id.polePDF:
                        try {
                            ...
                            Toast.makeText(ChiefJudge.this, "Moved To createPdf" + e, Toast.LENGTH_SHORT).show();
                            compName.setText(e.toString());
                        }

                        break;

                    case R.id.hangingPDF:

                        try {
                            createPdf(CompName, TeamName, AgeGrp,
                                    Nameh1, Nameh2, Nameh3, Nameh4, Nameh5, Nameh6,
                                    grandTotalh, grandTotalh2, grandTotalh3, grandTotalh4, grandTotalh5, grandTotalh6,
                                    s11, s21, s31, s41, s51, s61,
                                    s12, s22, s32, s42, s52, s62,
                                    s13, s23, s33, s43, s53, s63,
                                    s14, s24, s34, s44, s54, s64,
                    ...
                    case R.id.ropePDF:
                        ...
                        try {
                            createPdf(CompName, TeamName, AgeGrp,
                                    Namer1, Namer2, Namer3, Namer4, Namer5, Namer6,
                                    grandTotalr, grandTotalr2, grandTotalr3, grandTotalr4, grandTotalr5, grandTotalr6,
                                    s11, s21, s31, s41, s51, s61,
                                    s12, s22, s32, s42, s52, s62,
                                    s13, s23, s33, s43, s53, s63,
                                    s14, s24, s34, s44, s54, s64,
    ...
    private void createPdf(String CompName, String TeamName, String AgeGrp,
        ...
        File file = new File(pdfPath, TeamName+AgeGrp+typeSpin.getSelectedItem().toString()+".pdf");
        ...
        Paragraph Apparatus = new Paragraph(typeSpin.getSelectedItem().toString()).setBold().setFontSize(16).setTextAlignment(TextAlignment.CENTER);


        float[] width = {25f, 100f, 100f, 100f, 100f, 100f, 100f, 100f, 100f};
        Table table = new Table(width);
        table.setHorizontalAlignment(HorizontalAlignment.CENTER).setMarginLeft(75f).setMarginRight(75f).setMarginTop(50f);
        ...
        Toast.makeText(ChiefJudge.this, "Pdf Created @" + pdfPath, Toast.LENGTH_SHORT).show();


    }

    public float finalScore(float J1Mark, float J2Mark, float J3Mark, float J4Mark, float CJMark) {



        return (float) (J1Mark+J2Mark+J3Mark+J4Mark+CJMark)/5;
    }
