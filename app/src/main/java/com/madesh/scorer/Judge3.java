...
public class Judge3 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.judge_3);
...
//        ROPE Mallakhamb
    ...
    public void onBackPressed() {
        ...
        buid.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                startActivity(new Intent(Judge3.this,MainActivity.class));
            }
        });
                ...
                if (compName.getText().length()!=0 && teamName.getText().length()!=0&&
                    ...
                    collectionReference.document("Chief Judge").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Judge3.this, "Check the Details", Toast.LENGTH_SHORT).show();
                        }
                    });
